...
use App\Models\User;
//customer controller
class SalesPersonController extends MY_Controller
{
    public function users()
    {
        $data['users'] = User::where('roles', 'like', '%SalesPerson%')->get();
        return view('admin.users.salesperson', $data);
    }
    ...
    public function add_user(Request $request)
    {
        ...
        $result = $user->save();
        flash("Sales Person has been added successfully!")->success();
        return back();
    }
    ...
    public function delete_user(Request $request)
    {
        ...
        flash("Sales Person has deleted successfully!")->success();
        return back();
    }
    ...
    public function delete_multiple_user(Request $request)
    {
        ...
        flash("Selected Sales Person has added successfully!")->success();
        return back();
    }
    ...
    public function update_user(Request $request)
    {
        ...
        $user->status   = $request->status;
        $result         = $user->save();
        flash("Sales Person has updated successfully!")->success();
        return back();
    }
