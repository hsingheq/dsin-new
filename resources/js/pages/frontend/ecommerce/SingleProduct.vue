<template>
	...
	<div class="product-details">
		<div class="container">
			<div class="row">
				<div class="col-xl-6">
					<div class="product-details-nav d-sm-flex align-items-start">
						<div class="product-details-thumb">
							<div class="tab-content" id="productThumbContent">
								<div class="tab-pane fade" id="thumbOne" role="tabpanel" aria-labelledby="thumbOne-tab">
									<div class="product-details-nav-thumb w-img">
								...
								<div class="tab-pane fade active show" id="thumbThree" role="tabpanel"
							...
							<ul class="nav nav-tabs" id="productThumbTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="thumbOne-tab" data-bs-toggle="tab"
										data-bs-target="#thumbOne" type="button" role="tab" aria-controls="thumbOne"
										aria-selected="false">
										<img src="@/asset/images/products/product-1.jpg" alt="" height="50">
									</button>
								</li>
								<li class="nav-item" role="presentation">
								...
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="thumbThree-tab" data-bs-toggle="tab"
				...
				<div class="col-xl-6">
					<div class="product__details-content">
						<h6 class="title" v-html="product.product_title"></h6>
						...
						<div class="cart-option mb-15">
							...
							<numbercontrol :value="1" :min="1" :product="product" />
							<button type="button" class="cart-btn-2 ml-30 mb-10" @click="addToCart(product)">Add to Cart</button>
						</div>
	...
	<!-- Product Details Descriptions Starts -->
						...
						<ul class="nav nav-tabs" id="productDesTab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review"
									type="button" role="tab" aria-controls="review" aria-selected="false">Reviews (1)
								</button>
							</li>
						</ul>
					</div>
			...
			<div class="tab-content" id="prodductDesTaContent">
				<div class="tab-pane fade active show" id="des" role="tabpanel" aria-labelledby="des-tab">
					<div class="product__details-des-wrapper">
						<p class="des-text mb-35">Designed by Hans J. Wegner in 1949 as one of the first models created
							especially for Carl Hansen &amp; Son, and produced since 1950. The last of a series of chairs
							wegner designed based on inspiration from antique Chinese armchairs. The gently rounded top
							together with the back and seat offers a variety of comfortable seating positions,ideal for both
							long visits to the dining table and relaxed lounging.</p>
						<h6 class="des-sm-title">The standard passage, used since the 1500s.</h6>
						<p class="des-text mb-35">A light chair, easy to move around the dining table and about the room.
							Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
							pariatur. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor
							incididunt ut labore et dolore magna aliqua. Sit amet conse ctetur adipisicing elit, sed do
						...
						<div class="row">
							...
							<div class="col-xl-8">
								<div class="review-des-infod">
									<h6>1 review for " <span>Brother LC-3617 Black Ink</span>" </h6>
									<div class="review-details-des">
										<div class="author-image mr-15">
											<a href="#">
												<img src="@/asset/images/user.png" height="80" alt="">
											</a>
										</div>
										<div class="review-details-content">
											...
											<div class="name-date mb-30">
												<h6> admin – <span> Desc 22, 2022</span>
												</h6>
											</div>
											<p>A light chair, easy to move around the dining table and about the room. Duis
												aute irure dolor in reprehenderit in <br> voluptate velit esse cillum dolore
													...
													<div class="comment-agree d-flex align-items-center mb-25">
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="flexCheckDefault">
															<label class="form-check-label" for="flexCheckDefault"> Save my
	...
	<!-- Product Details Descriptions Ends -->
			...
			<div class="row mt-40">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
					<div class="product-item mb-20">
						...
						<div class="product-add-cart text-center">
							<button type="button"
								class="cart-btn-2 product-modal-sidebar-open-btn d-flex align-items-center justify-content-center w-100">
								Add to Cart </button>
						</div>
					</div>
				</div>
...
export default {
	...
	beforeMount() {
		...
		let url = `/api/get_product/` + route.params.slug
