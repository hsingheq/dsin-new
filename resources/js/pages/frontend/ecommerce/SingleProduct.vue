				...
				<div class="product-details-nav d-sm-flex align-items-start">
					<div class="product-details-thumb">
						<div class="tab-content" id="productThumbContent">
							...
							<div class="tab-pane fade active show" id="thumbThree" role="tabpanel" aria-labelledby="thumbThree-tab">
								<div class="product-details-nav-thumb w-img">
									<img src="@/asset/images/products/product-1.jpg" alt="">
								</div>
							</div>
						...
						<ul class="nav nav-tabs" id="productThumbTab" role="tablist">
							<li class="nav-item" role="presentation">
								<button class="nav-link" id="thumbOne-tab" data-bs-toggle="tab" data-bs-target="#thumbOne" type="button" role="tab" aria-controls="thumbOne" aria-selected="false">
							...
							<li class="nav-item" role="presentation">
								<button class="nav-link active" id="thumbThree-tab" data-bs-toggle="tab" data-bs-target="#thumbThree" type="button" role="tab" aria-controls="thumbThree" aria-selected="true">
									<img src="@/asset/images/products/product-1.jpg" alt="" height="50">
								</button>
							</li>
						</ul>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                <div class="product-item mb-20">
                    ...
                    <div class="product-add-cart text-center">
                        <button type="button" class="cart-btn-2 product-modal-sidebar-open-btn d-flex align-items-center justify-content-center w-100"> Add to Cart </button>
                    </div>
                </div>
            </div>
            <!-- Product Item 1 Ends -->
