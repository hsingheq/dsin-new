				   ...
				   <div class="product-widget">
					   ...
					   <div class="widget-content widget-category-list  mt-20">
						   <div class="single-widget-category" v-for="category in top_categories">
							   <input type="checkbox" :id="['cat-' + category.id]" name="cat-item" v-model="checkedCategories" @change="check($event)" :value="category.id">
							   <label :for="['cat-' + category.id]">{{category.category}} <span>({{ category.totalProduct }})</span>
							   </label>
						   </div>
					   </div>
				   </div>
					   ...
					   <div class="widget-content product__color mt-20">
						   <ul>
							   <li v-for="color in colors">
								   <a v-on:click="selectColor(color)" :class="[color.value, checkedColors ==  color.value? 'active' : '',]"></a>
							   </li>
						   </ul>
					   </div>
				   </div>
					   ...
					   <div class="widget-content widget-category-list mt-20">
						   <form action="#">
							   <div class="single-widget-category" v-for="sz in size">
								   <input type="checkbox" :id="['size-' + sz.id]"  v-model="checkedSize" @change="check($event)" :value="sz.value">
				   ...
				   <div class="product-widget mb-30">
					   ...
					   <div class="widget-content widget-category-list mt-20">
						   <div class="single-widget-category" v-for="brand in brands">
							   <input type="checkbox" id="['brand-' + brand.id]" name="brand-item" v-model="checkedBrand" @change="check($event)" :value="brand.id">
							   <label for="['brand-' + brand.id]">{{ brand.brand }} <span>({{ brand.totalProduct }})</span>
							   </label>
						   </div>
					   </div>
				   </div>
								   ...
								   <div class="product__filter-right d-flex align-items-center justify-content-md-end">
									   <div class="product__sorting product__show-no">
										   <div class="nice-select" tabindex="0">
											   ...
											   <ul class="list">
												   <li data-value="10" class="option selected" @click="pageLimit(2)">10</li>
									   ...
									   <div class="product__sorting product__show-position ml-20">
										   <div class="nice-select" tabindex="0">
											   ...
											   <ul class="list">
												   <li data-value="Latest" class="option selected" @click="pageSorting('latest')">Latest</li>
												   <li data-value="New" class="option"  @click="pageSorting('new')">New</li>
												   <li data-value="Up comeing" class="option"  @click="pageSorting('up-comeing')">Up comeing</li>
											   </ul>
										   </div>
									   </div>
				   ...
				   <div class="tab-content" id="productGridTabContent">
					   <div class="tab-pane fade  show active" id="FourCol" role="tabpanel" aria-labelledby="FourCol-tab">
						   <div class="tp-wrapper">
							   <div class="row">
								   <!-- Product Item Starts -->
								   <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" v-for="product in our_products.data" :key="product.id">
									   <div class="product-item product-item-d">
										   ...
										   <div class="d-flex justify-content-between align-items-center">
											   <button type="button" class="cart-btn-2 mb-10" @click="addToCart(product)"> Add to Cart </button>
							   ...
							   <div class="single-item-pd" v-for="product in our_products.data" :key="product.id">
								   <div class="row align-items-center">
									   ...
									   <div class="col-xl-3">
										   ...
										   <div class="stock-btn ">
											   <button type="button" class="cart-btn-2 d-flex mb-10 align-items-center justify-content-center w-100" @click="addToCart(product)"> Add to Cart </button>
					   ...
					   <div class="row">
						   <div class="col-xl-12">
							   <div class="basic-pagination pt-30 pb-30">
								   <Bootstrap5Pagination align="center" class="mb-30" :data="our_products" :limit=perPage :show-disabled="false" @pagination-change-page="getProducts" />
							   </div>
						   </div>
					   </div>
				   </div>
