    ...
    methods: {
        async handleDealerRegistration(values, actions) {
            ...
            if (this.v$.$invalid) {
                ...
                try {
                    await axios.post('/api/dealer-register', {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 offset-md-2">
                    <loading v-model:active="isLoading" :can-cancel="false" :on-cancel="onCancel"
                    ...
                    <div class="form-outline row my-4 mb-3">
                        ...
                        <div id="personal-information-box" v-if="registration_type == 'individual'">
                            ...
                            <div class="form-outline mb-3 row">
                                <div class="col-md-6 form-group required">
                                    ...
                                    <input type="text" class="form-control" name="first_name" v-model="v$.first_name.$model"
                        ...
                        <div class="form-outline row mb-3">
                            <div class="col-md-12 form-group required">
                                ...
                                <input type="text" id="nric_no" name="nric_no" class="form-control"
                                    v-model="v$.nric_no.$model"
                                    :class="{ valid: !v$.nric_no.$error && v$.nric_no.$dirty, 'is-invalid': v$.nric_no.$error }" />
                    ...
                    <!-- Personal Information Ends-->
                            ...
                            <div class="form-outline row mb-3">
                                <div class="col-md-12 form-group required">
                                    ...
                                    <input type="text" id="company_name" name="company_name" class="form-control"
                                        ...
                                        :class="{ valid: !v$.company_name.$error && v$.company_name.$dirty, 'is-invalid': v$.company_name.$error }" />
                                    <div class="invalid-feedback" v-for="(error, index) in v$.company_name.$errors"
                                        :key="index">
                                        {{ error.$message }}
                                    </div>
                                </div>
                            ...
                            <div class="form-outline row mb-3">
                                <div class="col-md-12 form-group required">
                                    ...
                                    <input type="text" id="company_registration_no" name="company_registration_no"
                                        class="form-control" v-model="v$.company_registration_no.$model"
                                        :class="{ valid: !v$.company_registration_no.$error && v$.company_registration_no.$dirty, 'is-invalid': v$.company_registration_no.$error }" />
                                    <div class="invalid-feedback"
                                        v-for="(error, index) in v$.company_registration_no.$errors" :key="index">
                                        {{ error.$message }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-outline row mb-3">
                            <div class="col-md-12 form-group required">
                                ...
                                <textarea as="textarea" id="address" name="address" class="form-control"
                                    v-model="v$.address.$model"
                                    :class="{ valid: !v$.address.$error && v$.address.$dirty, 'is-invalid': v$.address.$error }"></textarea>
                        ...
                        <div class="form-outline row mb-3">
                            <div class="col-md-12 form-group required">
                                ...
                                <input type="text" id="mobile" name="mobile" class="form-control" v-model="v$.mobile.$model"
                        ...
                        <div class="form-outline row mb-3">
                            <div class="col-md-12 form-group required">
                                ...
                                <input type="text" id="occupation" name="occupation" class="form-control"
                                    ...
                                    :class="{ valid: !v$.occupation.$error && v$.occupation.$dirty, 'is-invalid': v$.occupation.$error }" />
                        ...
                        <div class="form-outline row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea id="notes" name="notes" v-model="notes" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-outline row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="acceptance" id="acceptance"
                                        value="yes" v-model="v$.acceptance.$model"
                                        :class="{ valid: !v$.acceptance.$error && v$.acceptance.$dirty, 'is-invalid': v$.acceptance.$error }" />
                                    <label class="form-check-label" for="acceptance">Yes, and proceed to submit</label>
                                    <div class="invalid-feedback" v-for="(error, index) in v$.acceptance.$errors"
                                        :key="index">
                                        {{ error.$message }}
                                    </div>
                                </div>
