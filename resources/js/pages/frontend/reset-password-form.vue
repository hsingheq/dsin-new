						...
						<div class="col-md-8 col-lg-6 col-xl-4 login-box">
							...
							<Form @submit="ResetPassword" :validation-schema="schema" v-slot="{ errors }">
								...
								<div class="form-outline mb-4">
									...
									<Field type="password" id="password" v-model="password" name="password"
								...
								<div class="form-outline mb-4">
									...
									<Field type="password" id="password_confirmation" v-model="password_confirmation" name="password_confirmation"
