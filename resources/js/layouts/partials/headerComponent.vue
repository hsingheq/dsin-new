							...
							<div class="block-userlink text-end">
								<div class="user-links-wrapper">
									...
									<ul v-else>
										...
										<li><router-link v-if="token == 0" :to="{ name: 'Register' }">Register</router-link>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-6 text-end">
						<div class="menu-actions-link header-action text-sm-end">
							<div class="block-wishlist action">
								...
								<router-link class="icon-link" v-if="!token" :to="{ name: 'Login' }"
									:from="{ name: 'Wishlist' }">
									<i class="bi bi-heart"></i>
									<span class="text">Wishlist</span>
								</router-link>
								...
								<div class="cart" v-if="data.countCartItems > 0">
									<div class="cart-box">
										<ul>
											...
											<li>
												<router-link :to="{ name: 'Cart' }" class="wc-cart mb-10">View
													cart</router-link>
												<router-link :to="{ name: 'Cart' }"
													class="wc-checkout">Checkout</router-link>
											</li>
										</ul>
									</div>
								</div>
