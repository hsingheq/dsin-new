        ...
        <div class="col-lg-12">
            ...
            <div class="card" id="customerList">
                <div class="card-header ">
					...
					<div class="text-end buttons">
						<button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn"
							data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add New</button>
                ...
                <div class="card-body">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            <th scope="row">
                                                <div class="form-check">
                                                    <input class=" sub_chk" type="checkbox" name="id[]" value="{{ $user->id }}" data-id="{{ $user->id }}">
                                                </div>
                                            </th>
                                            ...
                                            <td class="roles">
                                                ...
                                                @if (!is_null($jroles))
                                                    @foreach ($jroles as $jrole)
                                                        <span class="badge rounded-pill text-bg-primary">{{ $jrole }}</span>
                                                    @endforeach
                                                @else
                                                    {{ 'No permission found!' }}
                                                @endif
                    ...
                    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('salesperson.add_user') }}" method="post" class="add-user-form">
                                    @csrf
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-sm-12">
                                                    ...
                                                    <input type="text" id="brand-field" name="email" class="form-control" placeholder="Enter email" required />
                                                </div>
                                                ...
                                                <div class="mb-3  col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12" id="user-roles">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" value="SalesPerson" class="form-check-input" checked name="roles[]" id="role-sales-person">
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add Sales Person</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <!--Add Sales Person Form Ends-->

                    <!--Edit Sales Person Form Starts-->
                    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ url('/admin/salesperson/update-user/') }}" enctype="multipart/form-data" method="post" class="edit-user-form">
                                    @csrf
                                    <div class="modal-body">
                    ...
                    <!--Edit Sales Person Form Ends-->
                    <!--Change Password Sales Person Form Starts-->
                    <div class="modal fade" id="ChangePassword" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('salesperson.change_password') }}" method="post" class="change-password-form">
                                    @csrf
                                    <div class="modal-body">
                    ...
                    <!--Change Password Sales Person Form Ends-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editbrand', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/admin/salesperson/edit-user/" + catid,
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.changePassword', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/admin/salesperson/get-change-password/" + password_id,
                    success: function(response) {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.remove-brand-btn').on('click', function(e) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "Are you sure you want to delete this Sales Person?",
                    icon: "question",
                    showCancelButton: true,
                    showCloseButton: true,
                }).then((result) => {
                    if (result.isConfirmed) {
                        window.location.href = "/admin/salesperson/delete-user/" + id;
                    }
                });
            });
            // bUlk Delete
            $('.delete-multiple').on('click', function(e) {
                ...
                if (users.length > 0) {
                    Swal.fire({
                        title: "Are you sure?",
                        text: "Are you sure you want to delete selected Sales Person?",
                        icon: "question",
                        showCancelButton: true,
                        showCloseButton: true,
                    }).then((result) => {
                        if (result.isConfirmed) {
                            //alert("Deleted");
                            window.location.href = "/admin/salesperson/delete-bulk-user/" + users;
                        }
                    });
                } else {
                    Swal.fire({
                        title: "No Sales Person selected.",
                        text: "",
                        icon: "warning",
                        showCancelButton: true,
                        showCloseButton: true,
