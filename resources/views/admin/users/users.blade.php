                                            ...
                                            <td>
                                                 ...
                                                 <div class="dropdown">
													...
													<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="">
														...
														<li><button class="dropdown-item remove-item-btn remove-brand-btn" data-id="{{ $user->id }}">Remove</button></li>
													</ul>
												</div> 
                                            </td>
                                        </tr>
                    ...
                    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.add_user') }}" method="post" class="add-user-form">
                                    @csrf
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="mb-3  col-sm-12">
                                                    ...
                                                    <select class="form-control" name="status" data-trigger name="status-field" id="user_status">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12" id="user-roles">
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" value="Admin" class="form-check-input user_roles" name="roles[]" id="role-admin">
                                                                <label for="role-admin">Admin</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" value="Dealer" class="form-check-input user_roles" name="roles[]" id="role-dealer">
                                                                <label for="role-dealer">Dealer</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" value="Customer" class="form-check-input user_roles" name="roles[]" id="role-customer">
                                                                <label for="role-customer">Customer</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="checkbox" value="SalesPerson" class="form-check-input user_roles" name="roles[]" id="role-sales-person">
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success submit-add-user" id="add-btn">Add User</button>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ url('/admin/users/update-user/') }}" enctype="multipart/form-data" method="post" class="edit-user-form">
                                    @csrf
                                    <div class="modal-body">
                    ...
                    <div class="modal fade" id="ChangePassword" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.change_password') }}" method="post" class="change-password-form">
                                    @csrf
                                    <div class="modal-body">
...
@section('modalAjax')
    <script>
        $(document).ready(function() {
			...
			// Show Edit user data to form
            $(document).on('click', '.editbrand', function() {
                var catid = $(this).val();
                $('#editModal').modal('show');
                $.ajax({
                    type: "GET",
                    url: "/admin/users/edit-user/" + catid,
            ...
            $(document).on('click', '.changePassword', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/admin/users/get-change-password/" + password_id,
                    success: function(response) {
            ...
            $('.delete-multiple').on('click', function(e) {
                ...
                if (users.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            //alert("Deleted");
                            window.location.href = "/admin/users/delete-bulk-user/" + users;
                        }
                    });
                } else {
                    Swal.fire({
