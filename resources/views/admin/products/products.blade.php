    ...
    <div class="col-lg-12">
        ...
        <div class="card" id="customerList">
            <div class="card-header ">
                ...
                <div class="text-end">
					<a type="button" class="btn btn-success add-btn"  id="create-btn" href="/admin/products/add-product"><i class="ri-add-line align-bottom me-1"></i> Add product</a>
                        ...
                        <table class="table align-middle" id="brandTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                            <input class=" sub_chk" type="checkbox" name="id[]"   value="{{$product->id}}" data-id="{{$product->id}}">
                                        </div>
                                    </th>
                                    ...
                                    {{-- <td class="email">{{$product->product_sku}}</td> --}}
                                    ...
                                    <td class="status">
                                        ...
                                        @else
                                        <span class="badge badge-soft-danger text-uppercase">Hidden</span>
                                        @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu " aria-labelledby="dropdownMenuLink1" data-popper-placement="bottom-start" style="">
                                                <li><a class="dropdown-item" href="/admin/products/view-product/{{$product->id}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                <li><a class="dropdown-item" href="/admin/products/edit-product/{{$product->id}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                <li><a href="#!" class="dropdown-item remove-item-btn remove-brand-btn" data-id="{{$product->id}}"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Remove</a></li>
                                            </ul>
                                        </div>
                            ...
                            <form action="/admin/add-product-brand" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" id="brandupload" name="brandimage" class="form-control"  onchange="PreviewImage();"  required />
                                        <img src="{{asset('')}}images/defaults/placeholder.png" id="placeholderimg" class="placeholderimg mt-3" />
                                    </div>    
                                    <div>
