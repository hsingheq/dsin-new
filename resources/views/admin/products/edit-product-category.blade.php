    ...
    <div class="col-lg-12">
        <div class="card" id="customerList">
            <div class="card-header border-bottom-dashed">
                ...
                <div class="text-end">
					<a href="{{ route('admin.productCategories') }}"  class="btn btn-success add-btn" >All Categories</a>
				</div>
            </div>
            ...
            <div class="card-body">
                <div class="container">
                     <div class="row">
                        <div class="col-lg-6">
                          <form action="{{ route('admin.update_Product_Category') }}" enctype="multipart/form-data" method="post" class="edit-product-category-form">
                              @csrf
                              <div class="modal-body">
                                 <input type="hidden" name="id" value="{{ $category->id }}" id="id">
                                  ...
                                  <div class="mb-3">
                                      ...
                                      <input type="text" id="slug" value="{{ $category->slug }}" name="slug" class="form-control" placeholder="Enter Slug" required />
                                  </div>
...
<!-- End Page-content -->
 ...
 $(document).ready(function() {
	 jQuery(".edit-product-category-form").validate({
			rules: {
				category: {
					required: true,
				},
