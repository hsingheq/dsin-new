    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{translate('Edit Coupon')}}</h3>
            </div>
            <form action="{{ route('admin.update_coupon') }}" method="POST">
...
$(document).ready(function(){
    ...
    function coupon_form(){
        ...
        var id = $('#id').val();
		$.post('{{ route('admin.get_coupon_form_edit') }}',{_token:'{{ csrf_token() }}', coupon_type:coupon_type, id:id}, function(data){
