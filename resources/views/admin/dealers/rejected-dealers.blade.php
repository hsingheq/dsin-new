                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    @foreach ($dealers as $dealer)
                                        <tr>
                                            ...
                                            <td><span class="badge rounded-pill text-bg-danger">{{ucfirst($dealer->status)}}</span></td>
                    ...
                    <div class="modal fade" id="ChangePassword" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('dealer.change_password') }}" method="post" class="change-password-form">
                                    @csrf
                                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.changePassword', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/admin/dealer/get-change-password/" + password_id,
                    success: function(response) {
