...
<div class="main-content">
    ...
    <div class="page-content" >
        <div class="container-fluid">
            ...
            <form id="createproduct-form" autocomplete="off" method="post" action="/admin/store-product/" class="needs-validation" novalidate>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product-title-input" value="" placeholder="Enter product title" name="product_title" required>
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_slug" id="" placeholder="Enter Slug" class="form-control">
                                    </div>
                                </div>
                                <div>
                                    <label>Product Description</label>
                                    <textarea name="product_description" id="editor" cols="30" rows="10" class="form-control"></textarea>
