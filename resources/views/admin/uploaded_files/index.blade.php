...
<div class="card">
    ...
    <!--<form id="sort_uploads" action="">
        <div class="card-header">
            <div class="col-md-12">
                <h5 class="">{{translate('All files')}}</h5>
				<div class="text-end">
    	...
    	<div class="container">
    		...
    		@foreach($all_uploads as $key => $file)
    			...
    			@endphp
					...
					<div class="col-lg-3 col-xs-2 mb-3">
    			<div class="">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" id="close-modal" aria-label="Close" data-bs-dismiss="modal" ></button>
            </div>
            <div class="modal-body text-center">
                <p class="mt-1">{{ translate('Are you sure to delete this file?') }}</p>
                <button type="button" class="btn btn-link mt-2" data-bs-dismiss="modal">{{ translate('Cancel') }}</button>
                <a href="uploaded-files/destroy/" class="btn btn-primary mt-2 comfirm-link">{{ translate('Delete') }}</a>
            </div>
        </div>
    </div>
</div>
...
<div id="info-modal" class="modal fade show">
