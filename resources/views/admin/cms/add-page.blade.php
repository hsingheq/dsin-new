...
@endif
@section('content')
<form id="add-post-form" novalidate class="needs-validation" action="{{ route('admin.cms.create_page') }}" method="post" enctype="multipart/form-data" autocomplete="off"  >
   @csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Page title" name="title" required value="">
            ...
            <div class="card">
                ...
                <!-- end card header -->
                <div class="card-body">
                    <textarea class="form-control" name="meta_description" id="excerpt" placeholder="Must enter minimum of a 100 characters"  rows="3"></textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <textarea class="form-control  aiz-tag-input" name="meta_keyword" id="excerpt" placeholder="Must enter minimum of a 100 characters"  rows="3"></textarea>
