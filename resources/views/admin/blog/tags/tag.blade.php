								...
								<td>
									<div class="d-flex gap-2">
										{{-- <div class="add-option">
											<a href="/admin/products/tag-options/{{$tag->id}}" class="btn btn-sm btn-secondary ">Add option</a>
										</div> --}}
										<div class="edit">
											<a href="{{ url('/admin/blog/edit-tag/').'/'. $tag->id}}" class="btn btn-sm btn-success" value="{{$tag->id}}">Edit</a>
										</div>
										<div class="remove">
                ...
                <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.blog.add_tag') }}" method="post" enctype="multipart/form-data" class="add-tag-form">
                                @csrf
        ...
        $('.remove-brand-btn').on('click', function(e){ 
            ...
            Swal.fire({
                ...
                if(result.isConfirmed) {
                     ...
                     window.location.href = "/admin/blog/delete-tag/" +id;
                }
            });
        });
        // bUlk Delete
        $('.delete-multiple').on('click', function(e){ 
            ...
            if(brands.length>0) {
                Swal.fire({
                    ...
                    if(result.isConfirmed) {
                        //alert("Deleted");
                        window.location.href = "/admin/blog/delete-bulk-tag/"+brands;
                    }
                });  
            } else {
                Swal.fire({
